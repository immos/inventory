...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
    		<div class="invoice-title">
    			<h2>Hertzsoft MART</h2><h3 class="pull-right pt-4">Order #<?php echo $print_row[0]; ?></h3>
    		</div>
    		<hr>
    		<div class="row">
    			<div class="col-xs-6">
    ...
    ?>
    							...
    							<tr>
    								<td> ddd</td>
    								<td class="text-center"><?php  echo $print_row1['sales_rate']; ?></td>
    								<td class="text-center"><?php echo $print_row1["sales_quantity"]; ?></td>
    								<td class="text-right"><?php echo $print_row1['sales_amount']; ?></td>
    							</tr>
...
<?php } ?>    							
    							...
    							<tr>
    								...
    								<td class="no-line text-right"><?php echo $print_row[8]; ?></td>
    							</tr>
