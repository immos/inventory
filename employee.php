...
<section>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="home-tab" data-toggle="tab" href="#employee_table" role="tab" aria-controls="home" aria-selected="true">Employee Records</a>
        </li>
    </ul>
    ...
    <div class="tab-content py-4">
        <!--------------------------------------add product section--------------------------->
        <div class="tab-pane active" id="employee_form" role="tabpanel" aria-labelledby="home-tab">
                ...
                <form method="post">
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" name="insertEmFName" class=" form-control form-control-sm" id="" aria-describedby="">
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="email" name="insertEmEmail" class="form-control  form-control-sm" />
                        </div>

                        <div class="form-group col-sm-6">
                            <label for="">Password</label>
                            <input type="password" name="insertEmPass" class="form-control form-control-sm" />
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="date" name="insertEmJDate" class="form-control form-control-sm" />
                        </div>
...
?>
        ...
        <!---------------------------table---------------------------->
        <div class="tab-pane " id="employee_table" role="tabpanel" aria-labelledby="profile-tab">
